...
class ControllerContractor extends Controller
{
    ...
    function action_index($action_param = null, $action_data = null)
    {
        ...
        if (!$contractor) {
            ...
            $this->view->balance = $this->model->getInformation($this->view->rows, $this->view->goods_rows);
            $this->view->goods_column_names = $this->model->contractor_goods_columns_names;
    ...
    public function setGoodsValues($contractor_id, $contractor_type)
    {
        ...
        $array = $this->model->getSelects($contractor_id, $contractor_type);
