...
class ModelSuppliers_order extends ModelOrder
{
    var $suppliers_orders_columns = [
        ...
        array('dt' => 5, 'db' => "CONCAT('<a href=\"javascript:;\" class=\"x-editable x-purchase_price\" data-pk=\"',
                ...
                IFNULL(CAST(suppliers_orders_items.purchase_price * IF(products.suppliers_discount > 0, products.suppliers_discount, 1) as decimal(64, 2)), ''),
                '\" data-url=\"/suppliers_order/change_item_field\" data-original-title=\"Enter Purchase Price\">',
                    IFNULL(CAST(suppliers_orders_items.purchase_price * IF(products.suppliers_discount > 0, products.suppliers_discount, 1) as decimal(64, 2)), ''),
                '</a>')"),
        array('dt' => 6, 'db' => "IFNULL(CAST(suppliers_orders_items.purchase_price * IF(products.suppliers_discount > 0, products.suppliers_discount, 1) * suppliers_orders_items.amount as decimal(64, 2)), '')"),
