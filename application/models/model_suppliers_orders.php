...
class ModelSuppliers_orders extends ModelManagers_orders
{
    ...
    var $suppliers_orders_columns = [
        ...
        array('dt' => 15, 'db' => "CAST(suppliers_orders_items.purchase_price * IF(products.suppliers_discount > 0, products.suppliers_discount, 1) as decimal(64, 2))"),
        array('dt' => 16, 'db' => "CAST(suppliers_orders_items.purchase_price * IF(products.suppliers_discount > 0, products.suppliers_discount, 1) * suppliers_orders_items.amount as decimal(64, 2))"),
