...
//                    CONCAT(CAST(trucks_items.number_of_packs as decimal(64, 3)), ' ', IFNULL(products.packing_type, '')),
//                '</a>'))"),
        array('dt' => 5, 'db' => "IFNULL(CAST(trucks_items.purchase_price * IF(products.suppliers_discount > 0, products.suppliers_discount, 1) as decimal(64, 2)), '')"),
        array('dt' => 6, 'db' => "IFNULL(CAST(trucks_items.purchase_price * IF(products.suppliers_discount > 0, products.suppliers_discount, 1) * trucks_items.amount as decimal(64, 2)), '')"),
