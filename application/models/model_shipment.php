...
class ModelShipment extends ModelManagers_orders
{
    ...
    var $suppliers_orders_columns = [
        ...
        array('dt' => 16, 'db' => "CAST(trucks_items.purchase_price * IF(products.suppliers_discount > 0, products.suppliers_discount, 1) as decimal(64, 2))"),
        array('dt' => 17, 'db' => "CAST(trucks_items.purchase_price * IF(products.suppliers_discount > 0, products.suppliers_discount, 1) * trucks_items.amount as decimal(64, 2))"),
