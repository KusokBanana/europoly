...
<div class="user-login-5">
    <div class="row bs-reset">
        <div class="col-md-6 bs-reset">
            <div class="login-bg" style="background-image:url(./assets/pages/img/login/2.jpg)">
                <img class="login-logo" src="./assets/layouts/layout6/img/logo1.png" style="width: 150px;"/></div>
        </div>
                ...
                <div class="row bs-reset">
                    ...
                    <div class="col-xs-7 bs-reset">
                        <div class="login-copyright text-right">
                            <p>Copyright &copy; Evropoly 2016</p>
                        </div>
                    </div>
                </div>
            </div>
